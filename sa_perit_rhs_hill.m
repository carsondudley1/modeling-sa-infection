function f = sa_perit_rhs(t, state)
    ...
    f(1) = r*(sa + saf)*(1 - (sa + saf)/ksa) - gl*(((m/sa)^h)/((0.001^h) + (m/sa)^h))*sa - gl*((((n)/sa)^h)/((0.001^h) + (n/sa)^h))*sa - glf*(((mf/sa)^h)/((0.0002^h) + (mf/sa)^h))*sa - glf*(((nf/sa)^h)/((0.0002^h) + ((nf)/sa)^h))*sa - asa*sa*large + bsa*saf;
    ...
    f(25) = (rfi)*saf*(1 - (sa + saf)/ksa) + asa*sa*large - bsa*saf - gl*(((m/(saf + 1000))^h)/((0.001^h) + (m/(saf + 1000))^h))*saf - gl*((((n)/(saf + 1000))^h)/((0.001^h) + (n/(saf + 1000))^h))*saf - glf*(((mf/(saf + 1000))^h)/((0.0002^h) + (mf/(saf + 1000))^h))*saf - glf*(((nf/(saf + 1000))^h)/((0.0002^h) + ((nf)/(saf + 1000))^h))*saf;
